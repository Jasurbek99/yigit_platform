-- ============================================================
-- YGT HOLDING — MSSQL DDL SCRIPT v5.0
...
CREATE TABLE core.shipment_status_types (
    ...
    required_role NVARCHAR(30),
    phase NVARCHAR(20)
);

-- Users table (extends Django auth_user concept)
...
PRINT 'YGT Platform database schema created successfully.';
GO
