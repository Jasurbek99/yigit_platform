...
export const MOCK_DRAFTS: IShipmentDraft[] = [
  {
    id: 1001,
    shipment_code: '17AP197/26',
    date: today,
    created_at: todayTs,
    created_by_name: 'Soltanmyrat',
    weight_net: 18500,
    export_code: '17|AP|197|A4|26|08',
