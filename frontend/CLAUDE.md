...
Loaded when working with files under `frontend/`.
Always-loaded rules live in the root `CLAUDE.md`.
...
Code quality rules. For architecture (state management, file organization, auth) see the
**Frontend Architecture Rules** section above.
