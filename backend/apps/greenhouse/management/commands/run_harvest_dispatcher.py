...
Week-grid initialization and weekly-plan task generation are NOT done here —
they run once a day in `run_weekly_plan_setup`, which needs no 5-minute cadence.
