"""Tests for validate_export_code in apps.export.validators."""

from django.core.exceptions import ValidationError
from django.test import TestCase

from apps.core.models import TomatoVariety
from apps.export.validators import validate_export_code
...
class ValidateOfficialExportCodeTest(TestCase):
    ...
    def test_valid_full_code(self) -> None:
        ...
        validate_export_code('22|AP|202|A4|26|02')  # must not raise
