...
4. Flag data quality issues: nulls in required fields, shipment code format violations, weight inconsistencies, orphan references
5. Output: sheet summary, column-to-table mapping, quality report, migration script skeleton

Key validation rules:
- Shipment code format: `DDMM###/YY`
