...
- **Close manifest** (`POST /shipments/{id}/manifest/close/`) — aggregates pallet weights into shipment totals + dominant-variety roll-up (`close_pallet_manifest()`). Frontend: `useCloseManifest`.
