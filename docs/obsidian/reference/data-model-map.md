...
| Model | Key Fields | Purpose |
|-------|-----------|---------|
| **Shipment** | shipment_code (unique), date, season, country, customer, status, 8 AD-1 timestamps + status_changed_at (Stream E), weight fields, transport fields, finance fields, vehicle condition | Main record — 1 per truck |
