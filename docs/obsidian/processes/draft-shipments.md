...
- `harvest_date`, `harvest_status` and `weight_to_load_kg` are copied to the target if the target's are empty (**added 2026-09-09, F25**).
...
> `weight_to_load_kg` — three of the five cells Stage 0 asks Soltanmyrat to fill on the
